...
namespace Queries
{
    public interface Request<TResult> where TResult : class
    {}

    public delegate IEnumerable<TResult> QueryFunction<TResult>(Request<TResult> input) where TResult : class;
