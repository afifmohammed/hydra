        ...
        where TStateConnectionString : class
    {
        ...
        public static void Handler(IReadOnlyCollection<Subscription> subscriptions)
        {
            ...
            (
                ...
                notifications => PostBox<AdoNetTransactionScopeUowProvider>.Post(notifications.SelectMany(notification => new Event {EventId = new NoEventId(), Notification = notification}.SubscriberMessages(subscriptions))),
